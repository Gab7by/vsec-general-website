# Design System Master File — VSEC Official Brand

> **LOGIC:** When building a specific page, first check `design-system/vsec/pages/[page-name].md`.
> If that file exists, its rules **override** this Master file.
> If not, strictly follow the rules below.
> **Source of truth:** VSEC Internal Brand Standard Guide (official PDF)

---

**Project:** VSEC
**Generated:** 2026-05-28 11:14:37
