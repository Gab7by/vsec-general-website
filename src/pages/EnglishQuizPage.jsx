...
import { ArrowRight, CheckCircle, XCircle, RotateCcw, BookOpen, GraduationCap } from 'lucide-react'
import { questions, levelResults, getLevel } from '../data/quizQuestions'

const FEEDBACK_DELAY = 900 // ms before advancing to next question
...
export default function EnglishQuizPage() {
  ...
  const [locked, setLocked] = useState(false)    // disable buttons during feedback
  ...
  if (phase === 'intro') {
    return (
      <main>
        ...
        >
          <div aria-hidden="true" className="absolute top-0 right-0 w-[500px] h-[500px] rounded-full pointer-events-none opacity-10"
          ...
          <div className="section relative text-center">
            ...
            <p className="text-base md:text-lg max-w-xl mx-auto"
              ...
              Answer 20 questions and instantly discover your CEFR proficiency level — from Beginner to Advanced — along with your personalised course recommendation.
            </p>
          </div>
        </section>
